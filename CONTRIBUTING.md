...
* [GitHub Issues](https://github.com/apinprastya/revel/issues)
...
```
$ go get github.com/apinprastya/revel                        # Install Revel
$ cd $GOPATH/src/github.com/apinprastya/revel                # Change directory to revel repo
...
```
$ go test github.com/apinprastya/revel
```

Refer to the
[Travis configuration](https://github.com/apinprastya/revel/blob/master/.travis.yml)
...
[issues](https://github.com/apinprastya/revel/issues?labels=contributor+ready&page=1&state=open).
